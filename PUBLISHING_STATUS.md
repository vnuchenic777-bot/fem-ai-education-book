...
| Статья 02. Методология ДПО | подключена как публикационная редакция v0.3 | `book/06_research_articles/article_02_dpo_methodology.md` |
...
Продолжить проработку серии статей: дополнить визуальный слой фонда оценочных средств и итогового проекта либо перейти к подготовке журнальной версии одной выбранной статьи под требования конкретного издания.
