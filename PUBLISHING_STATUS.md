...
Вторая статья научно-публикационного контура подготовлена как рабочая версия v0.1: `book/06_research_articles/article_02_dpo_methodology.md`. Статья получила обобщённую рамку «Методология проектирования программ ДПО по ИИ-инструментам для преподавателей: компетенции, оценивание и цифровое сопровождение образовательного результата». Авторская программа на 72 часа описана как апробационная конфигурация универсализируемой модели, а не как узкий локальный отчёт.
...
| Статья 02. Методология ДПО | подключена как публикационная редакция v0.1 | `book/06_research_articles/article_02_dpo_methodology.md` |
...
В `bibliography.bib` добавлены 21 источниковая запись: 10 начальных нормативных, международных и технических источников, а также 11 внешних русскоязычных научных публикаций для статьи 01.
...
- `scripts/validate_data.py`: OK, проверено 70 JSON и 84 YAML.
...
Перейти к следующему редакционному этапу: выбрать целевой журнал или конференционный сборник для статьи 01 и привести текст, объем, список источников и оформление к требованиям конкретного издания.
