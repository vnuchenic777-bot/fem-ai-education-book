...
Третья статья научно-публикационного контура подготовлена как рабочая версия v0.1: `book/06_research_articles/article_03_certification_model.md`. Статья описывает методико-техническую модель цифрового документа результата обучения, QR-проверку, аудит, хранение PDF и разграничение методического, технического и юридического статуса документа.
...
- редакционный архив статьи 03 v0.1 в `data/branches/06_research_articles/article_03_certification_model_v0_1/`.
...
| Статья 03. Цифровой документ результата обучения | подключена как публикационная редакция v0.1 | `book/06_research_articles/article_03_certification_model.md` |
...
В `bibliography.bib` добавлены 32 источниковые записи: 11 начальных нормативных, международных и технических источников, 11 внешних русскоязычных научных публикаций для статьи 01, а также 10 дополнительных источников для статьи 02.
...
- `scripts/validate_data.py`: OK, проверено 70 JSON и 86 YAML.
...
- Подобрать внешний научный обзор для статьи 03 по цифровым документам об обучении, микроквалификациям, верифицируемым credentials и публичной проверке документов.
...
Продолжить проработку серии статей: усилить статью 03 внешним научным обзором или перейти к визуализациям для статей 01-03.
