...
| Статья 02. Методология ДПО | подключена как допилотная журнальная редакция v0.4 | `book/06_research_articles/article_02_dpo_methodology.md` |
...
- После пилотного запуска курса в июле 2026 года добавить в статью 02 агрегированные данные прохождения, графики активности, распределение оценок, анализ итоговых проектов и обратную связь преподавателей.
...
Продолжить проработку статьи 02 как журнальной редакции: подготовить шаблон будущего раздела результатов пилота и визуальные заготовки для графиков активности, оценивания и обратной связи.
