...
| Статья 02. Методология ДПО | подключена как допилотная журнальная редакция v0.5 | `book/06_research_articles/article_02_dpo_methodology.md` |
...
- После пилотного запуска курса в июле 2026 года заполнить шаблон результатов статьи 02 агрегированными данными прохождения, графиками активности, распределением оценок, анализом итоговых проектов и обратной связью преподавателей.
...
Продолжить проработку статьи 02 как журнальной редакции: подготовить скрипт или notebook для построения будущих графиков пилота по агрегированным данным.
