...
- Федеральный закон № 63-ФЗ «Об электронной подписи» используется как рамка, которую необходимо проверять при выборе способа электронной подписи или подтверждения электронного документа {cite}`electronic_signature_law_63fz`.
- Указ Президента Российской Федерации № 490 и изменения к нему используются как стратегическая рамка развития искусственного интеллекта в Российской Федерации {cite}`russian_ai_strategy_490_2019,russian_ai_strategy_amendment_124_2024`.
