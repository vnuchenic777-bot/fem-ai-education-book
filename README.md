...
Книга собирает Markdown-главы, Jupyter Notebook, YAML/JSON-данные, диаграммы и инженерные спецификации проекта. HTML-версия должна генерироваться автоматически через Jupyter Book.
